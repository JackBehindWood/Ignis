...
public:
    ...
    inline MetalCommandQueue& graphics_queue()
    {
        return get_queue(MetalQueueType::Graphics);
    }
    inline MetalCommandQueue& compute_queue()
    {
        return get_queue(MetalQueueType::Compute);
    }
    inline MetalCommandQueue& transfer_queue()
    {
        return get_queue(MetalQueueType::Transfer);
    }
