...
_NS_OPTIONS(NS::UInteger, wNSWindowStyleMask){WindowStyleMaskBorderless             = 0,
...
_NS_ENUM(NS::UInteger, wNSBackingStoreType){BackingStoreRetained = 0, BackingStoreNonretained = 1,
...
_NS_INLINE wNSWindow* wNSWindow::init(CGRect content_rect, wNSWindowStyleMask style_mask, wNSBackingStoreType backing,
                                      bool defer)
{
    return NS::Object::sendMessage<wNSWindow*>(this,
                                               _NSWRAPPER_PRIVATE_SEL(init_with_content_rect_style_mask_backing_defer_),
                                               content_rect, style_mask, backing, defer);
}
