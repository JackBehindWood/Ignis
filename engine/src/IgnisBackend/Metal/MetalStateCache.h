...
namespace Ignis
{
    ...
    public:
        ...
        inline const GRIRenderPassInfo&   get_pending_pass_info()     const { return m_pending_pass_info; }
        inline MTL::RenderPassDescriptor* get_render_pass_descriptor()      { return m_render_pass_descriptor; }

        // Index buffer
        void set_index_buffer(MTL::Buffer* buffer, MTL::IndexType type, NS::UInteger offset);

        inline MTL::Buffer*    get_index_buffer()       const { return m_index_buffer; }
        inline MTL::IndexType  get_index_type()         const { return m_index_type; }
        inline NS::UInteger    get_index_buffer_offset() const { return m_index_buffer_offset; }
