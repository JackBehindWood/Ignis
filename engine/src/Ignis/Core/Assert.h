...
#include "Ignis/Core/Log.h"
	...
	#define IG_INTERNAL_ASSERT_NO_MSG(type, check) IG_INTERNAL_ASSERT_IMPL(type, check, "Assertion '{0}' failed at {1}:{2}", IG_STRINGIFY_MACRO(check), Ignis::Path(__FILE__).filename().string(), __LINE__)
