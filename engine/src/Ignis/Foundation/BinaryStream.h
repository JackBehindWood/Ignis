...
public:
    ...
    {
        m_stream.write(reinterpret_cast<const char*>(&v), 1);
    }
    void write_u16(uint16_t v)
    {
        m_stream.write(reinterpret_cast<const char*>(&v), 2);
    }
    void write_u32(uint32_t v)
    {
        m_stream.write(reinterpret_cast<const char*>(&v), 4);
    }
    void write_u64(uint64_t v)
    {
        m_stream.write(reinterpret_cast<const char*>(&v), 8);
    }
...
public:
    ...
    {
        uint8_t v;
        m_stream.read(reinterpret_cast<char*>(&v), 1);
        return v;
    }
    uint16_t read_u16()
    {
        uint16_t v;
        m_stream.read(reinterpret_cast<char*>(&v), 2);
        return v;
    }
    uint32_t read_u32()
    {
        uint32_t v;
        m_stream.read(reinterpret_cast<char*>(&v), 4);
        return v;
    }
    uint64_t read_u64()
    {
        uint64_t v;
        m_stream.read(reinterpret_cast<char*>(&v), 8);
        return v;
    }
